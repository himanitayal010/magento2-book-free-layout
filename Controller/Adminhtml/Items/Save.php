...
class Save extends \Magneto\BookLayout\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $imagePath = 'magneto/booklayout'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('magneto_booklayout/*/view', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('magneto_booklayout/*/view', ['id' => $id]);
                } else {
                    $this->_redirect('magneto_booklayout/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('magneto_booklayout/*/view', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('magneto_booklayout/*/');
